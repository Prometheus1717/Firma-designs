...
export const CONTENT = {
  en: {
    ...
    features: [
      ...
      { num: '04', title: <>Your full natal chart, computed properly</>, lead: 'Underneath the map sits a real birth chart — calculated from planetary ephemeris, not lookup tables.', points: ['Open your natal chart up close — the full wheel and every placement', 'Switch to Personality and read your Sun, Venus and Ascendant in plain language', 'Export your full chart and readings as a PDF'], media: { type: 'img', src: '/landing/app-natal.webp', alt: 'Natal chart panel with planet positions, zodiac signs, degrees and life domains' } },
  ...
  ja: {
    ...
    features: [
      ...
      { num: '04', title: <>あなたの完全な出生図を、正しく計算</>, lead: '地図の下には本物の出生図 — 早見表ではなく惑星の天体暦から計算。', points: ['ネイタルホイールと完全な表：サイン、度数、エレメント、逆行', 'astronomy-engine ライブラリ搭載 — 秒角未満の精度', 'プロの占星術ソフトが描くのと同じ図'], media: { type: 'img', src: '/landing/app-natal.webp', alt: '惑星位置、星座、度数、人生の領域を示す出生図パネル' } },
  ...
  zh: {
    ...
    features: [
      { num: '01', title: <>交互式3D星位天文地球</>, lead: 'Natal Navigator 的核心。你的整张出生星盘投影到一个可旋转的地球上——不是静态地图图片。', points: ['全部40条行星线：从太阳到冥王星每颗行星的 MC、IC、ASC 和 DSC', '实时拖动、旋转、缩放——逐一开关每颗行星', '你的出生地与你星线上的每座城市，均已标记且可点击'], media: { type: 'img', src: '/landing/app-globe.webp', alt: '带有40条行星线、行星开关与评分城市的3D星位天文地球' } },
      ...
      { num: '04', title: <>你的完整出生星盘，正确计算</>, lead: '地图之下是一张真正的出生星盘——由行星星历计算而来，而非查表。', points: ['本命星盘加完整表格：星座、度数、元素、逆行', '由 astronomy-engine 库驱动——亚角秒级精度', '与专业占星软件所绘相同的星盘'], media: { type: 'img', src: '/landing/app-natal.webp', alt: '展示行星位置、黄道星座、度数与人生领域的本命星盘面板' } },
  ...
  ko: {
    ...
    features: [
      ...
      { num: '04', title: <>당신의 완전한 출생 차트, 제대로 계산</>, lead: '지도 아래에는 진짜 출생 차트가 있습니다 — 조견표가 아니라 행성 천체력에서 계산됩니다.', points: ['네이탈 휠과 완전한 표: 별자리, 도수, 원소, 역행', 'astronomy-engine 라이브러리 기반 — 호초 미만의 정밀도', '전문 점성술 소프트웨어가 그릴 것과 동일한 차트'], media: { type: 'img', src: '/landing/app-natal.webp', alt: '행성 위치, 황도 별자리, 도수, 삶의 영역을 보여주는 출생 차트 패널' } },
