...
export default function Globe({ lines, citiesOnLines, citiesTiers, homeLocation, onCityClick, flat, lightMode }) {
  ...
  return (
    <div style={{ position: 'relative', width: '100%', height: '100%' }}>
      ...
      <div data-tutorial="layerToggles" style={{ position: 'absolute', bottom: isMobile ? 8 : 12, left: isMobile ? 8 : 12, zIndex: 50, display: 'flex', flexDirection: 'column', gap: isMobile ? 4 : 6 }}>
        <button
          onClick={toggleLines}
